...
def load_mlb_scores():
	...
	for game in games:
		...
		message = "Before if: " +game.team_away + game.outcome.away + game.team_home + game.outcome_home
		logger.info(message)
		if game.outcome_away == None and game.outcome_home == None:
			message = "After if: " +game.team_away + game.outcome.away + game.team_home + game.outcome_home
			logger.info(message)
